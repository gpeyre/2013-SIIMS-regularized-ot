function [Sigma,Z,W,err] = perform_ot_symmetric_regul_linprog(X,Y,Gx,Gy,kx,KX,ky,KY,Total,lambda1,lambda2,options)
...
%  (0 <= Sigma_i,j <= 1 )? 
%
% restrictions on k: 0<=kx<=KX (idem for ky) 
%
...
Amin = [    ...
    kx*ones(N,1); ...         %    0 <= Sigma*1  
    ky*ones(N,1); ...         %    0 <= 1'*Sigma
    N                         %    N <= 1' Sigma 1
    % Total; ...                %    N <= 1' Sigma 1 
